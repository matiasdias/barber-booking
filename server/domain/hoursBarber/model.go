...
type FormartHours struct {
	StartTime      *string `json:"horario_inicial"`
	LunchStartTime *string `json:"horario_almoco_inicial"`
	LunchEndTime   *string `json:"horario_almoco_final"`
	EndTime        *string `json:"horario_final"`
}
...
type FormartHoursException struct {
	DateException *string `json:"data_execeção" conversor:"data_execeção"`
}
